document.addEventListener('DOMContentLoaded', function () {
  ...
  if (dialogueForm) {
      ...
      saveBtn.addEventListener('click', function () {
          ...
          const recommendation = document.getElementById('dialogue6').value;
          const doaApplicable = document.querySelector('input[name="doa"]:checked').value;
          ...
          addSection('Recommendation:', recommendation);
          addSection('DOA Applicable:', doaApplicable);

          // Save PDF
          doc.save('TCC_Final_Note.pdf');
