document.addEventListener('DOMContentLoaded', function () {
    ...
    if (dialogueForm) {
        ...
        saveBtn.addEventListener('click', function () {
            ...
            const perspective = document.getElementById('dialogue6').value;
            const proposal = document.getElementById('dialogue7').value;
            const conclusion = document.getElementById('dialogue8').value;
            ...
            doc.setFontSize(18);
            doc.text('IN-PRINCIPLE APPROVAL', 10, 20);
